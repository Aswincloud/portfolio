...
export const additionalProjects = [
  ...
  },
  {
    ...
    description:
      'A Telegram-driven download orchestrator that queues, tracks, and manages transfers from heterogeneous sources behind one interface. Normalizes different backends into a single job model with live progress, then organizes completed files in cloud storage.',
    technologies: ['Python', 'Telegram Bot API', 'aria2', 'yt-dlp', 'Cloud Storage'],
    features: [
      'Unified job queue across multiple download backends',
      'Concurrent transfers with per-job progress tracking',
      'Adapter layer normalizing aria2 and yt-dlp sources',
      'Automatic retry on failure and post-download file organization',
      'Stateful control (pause / resume / cancel) over chat',
    ],
    icon: <Zap size={48} />,
